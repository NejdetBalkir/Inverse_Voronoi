...
def fun_vor_main_visualization(vor):
    ...
    from center_search_for_visualization import center_search_for_visualization
    first_three_cell_centers, mirrored_centers_to_cell = center_search_for_visualization(explicit_voronoi,vertices)
    ...
    return explicit_voronoi, vertices, first_three_cell_centers, mirrored_centers_to_cell