...
def fun_vor_main_perturbation(vor,points,perturbed_vertex_index,delta):
    ...
    from center_search_perturbation import center_search_perturbation
    ...
    cell_centers, cell_centers_iteration = center_search_perturbation(explicit_voronoi,vertices,perturbed_vertex_index,delta)
